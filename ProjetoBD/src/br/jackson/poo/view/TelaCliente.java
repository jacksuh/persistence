...
import br.jackson.poo.persistencia.Cliente;
import br.jackson.poo.persistencia.ClienteDAO;
...
public class TelaCliente extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnSalvar) {
            ...
            //se a conexão for realizada exibir cadastrado com sucesso validação dos campos
